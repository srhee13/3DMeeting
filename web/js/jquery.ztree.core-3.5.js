    ...
    var settings = {},
        ...
        view = {
            ...
            makeDOMNodeLine: function(html, setting, node) {
                html.push("<div><span id='", node.tId, consts.id.SWITCH, "' title='' class='", view.makeNodeLineClass(setting, node), "' treeNode", consts.id.SWITCH, "></span>");
            },
            ...
            makeDOMNodeMainBefore: function(html, setting, node) {
                if (node.isParent) {
                    ...
                    html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, " low-node' tabindex='0' hidefocus='true' treenode>");
                }
            },
